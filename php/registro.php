...
if(!empty($_POST)){
	if(isset($_POST["plan"]) &&isset($_POST["rut"])  &&isset($_POST["name"]) &&isset($_POST["surname"]) &&isset($_POST["email"]) &&isset($_POST["password"]) &&isset($_POST["confirm_password"])){
		if($_POST["plan"]!=""&& $_POST["rut"]!=""&& $_POST["name"]!=""&& $_POST["surname"]!=""&&$_POST["email"]!=""&&$_POST["password"]!=""&&$_POST["password"]==$_POST["confirm_password"]){
			include "fc.php";
